...
W przypadkach podobnych do epidemii koronawirusa należy wprowadzać stan nadzwyczajny:
  * Uważam, że powinno się wprowadzić stan nadzwyczajny. We współczesnych czasach powinien on zostać wykorzystany do wprowadzenia obowiązkowego śledzenia kontaktów np. za pomocą aplikacji/smartfonów i szczegółowego wprowadzenia izolacji zarażonych osób. Zdaję sobię sprawę, że było by to naruszenie obecnie obowiązujących swobód w przemieszczaniu się, jednakże korzyści całego społeczeństwa przewyższają straty pojedyńczych jednostek, które mogłyby przyczyniać się do daleszego rozprzestrzeniania wirusa.
  * W celu przeciwdziałania nadużyciom powinniśmy zaprosić zewnętrznych obserwatorów, tak jak to się dzieje w przypadku wyborów, do stałego monitorowania i zgłaszania przypadków, kiedy wprowadzane ograniczenia zostają użyte do celów nie związanych z epidemią.
  * Uważam, że powinny zostać wprowadzone obowiązkowe kontrole na granicach krajów i województw, gdzie blokowano by podejrzane przypadki, a takze wykonywano by przesiwowe testy (podróżujący nie musieli by na ich wyniki czekać). 
...
## Wolnośc obywatelska / Państwo świeckie
...
## Polityka energetyczna / ochrona klimatu
...
Ponad 40% polaków mieszka w budynkach wielorodzinnych. W polsce powinno się promować montowanie ładowarek elektrycznych i paneli fotowoltaicznych.
...
Powinien zostać wprowadzony podatek obrotowy np w wysokości 0.1% zamiast wszelkich dotychczasowych podatków. Nie powinny być wprowadzane żadne nowe podatki, bez zatwierdzenia ich np. w referendum.
Uważam, że 500+ powinno zostać rozwinięte do UBI/podstawowego powszechnego dochodu wraz z likwidacją wszystkich innych świadczeń państwowych.
...
Polska powinna wprowadzić podatek od cyfrowych gigantów (dużych międzynarodowych firm prowadzących w Internecie działalność skierowaną do polskich użytkowników).  
  Nie zgadzam się, uważam niesprawiedliwe za stosowanie takich podatków.
  Uważam, że powinien zostać wprowadzony pojedyńczy jednolity podatek od obrotu firm zamiast wszystkich dotychczasowych. 
...
Zamiast udzielać dopłat na wynajem mieszkań budowanych przez prywatne firmy, państwo powinno finansować budowanie mieszkań komunalnych.
  Nie zgadzam się.
  Państwo powinno ograniczyć swój wpływ w tej branży i powinno natychmiast zaprzestać wszelkich programów "Rodzina na swoim", "Mieszkanie dla młodych" itp. gdyż skutkują one tylko większą niedostępnością mieszkań.
...
Należy wprowadzić możliwość przejścia na wcześniejszą emeryturę dla osób, które przepracowały większą liczbę lat, niezależnie od ich wieku.
  Zgadzam się.
  Uważam, że emerytura powinna być własnością każdego obywatela, a decyzja o prześciu na wcześniejszą emeryturę powinno należeć do jej właściciela. Emerytura podstawowa od państa powinna być zapewniana przez UBI.
...
Coraz większą część społeczeństwa będą stanowić osoby starsze, które już nie pracują.  Jaką politykę Pani/ Pana zdaniem powinno prowadzić państwo, aby utrzymać stabilny rozwój kraju i jednocześnie płacić emerytury?
  1. Uważam, że nie powinniśmy wprowadzać dodatkowych regulacji w tej kwesti, poza stałym informowaniem przyszłych emerytów o wysokości ich emerytur.
  2. Polityka prorodzinna nie rozwiąże problemu zbyt małej liczby pracowników. Potrzebujemy pracowników z zagranicy.
  3. Należy zachęcać obywateli do posiadania większej liczby dzieci.
...
## Polityka zagraniczna / obronność Polski
...
Unia Europejska powinna mieć mniejszy wpływ na polską politykę wewnętrzną.
  Nie zgadzam się.
  Uważam, że UE powinna każdorazowo podejmować dialog w celu standaryzacji regulacji w całej UE. Myślę, że czas najwyższy na głosowanie czy UE w której jesteśmy powinna zostać oprócz unii gospodarczej także unią polityczną.
...
Polska powinna przyjmować większą liczbę imigrantów zarobkowych z innych krajów.
  Zgadzam się,
  Procedury w tym zakresie starania się o pracę powinny być maksymalnie uproszczone. Nie powinniśmy jednak otaczać natychmiast imigrantów identyczną opieką socjalną jak obecnych obywateli.
...
Polskie drogi są jednymi z najbardziej niebezpiecznych w Europie – co roku prawie 3 tys. osób ginie w wypadkach.  Które z poniższych rozwiązań najskuteczniej ograniczy Pani/Pana zdaniem liczbę wypadków?
  Uważam, że należy dopuścić by drogi mogły być prywatne. Ich finansowanie powinno być zapewnione przez przekazywanie obecnych wpływów z akcyzy do ich właścicieli.
  
Uważam, że należy podjąć działania zmierzające docelowo do systemu demokracji bezpośredniej. Jako pierwszy krok wskazałbym przejście na głosowanie przez przedstawiciela, którego można zmienić np. co kwartał.
